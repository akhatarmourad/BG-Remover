...
export default function Steps() {
  return (
    <div className="flex flex-col items-center justify-center mx-4 lg:mx-40 my-32">
        <h1 className="mx-auto max-w-72 text-center font-bold text-xl bg-gradient-to-r from-gray-800 via-gray-600 to-gray-800 text-transparent bg-clip-text">Your Guideline to Remove Image&apos;s Background</h1>
